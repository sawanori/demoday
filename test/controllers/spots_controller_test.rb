...
class SpotsControllerTest < ActionController::TestCase
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post :create, spot: { charge: @spot.charge, description: @spot.description, phone: @spot.phone, place: @spot.place, title: @spot.title, user_id: @spot.user_id }
    end
  ...
  test "should update spot" do
    patch :update, id: @spot, spot: { charge: @spot.charge, description: @spot.description, phone: @spot.phone, place: @spot.place, title: @spot.title, user_id: @spot.user_id }
    assert_redirected_to spot_path(assigns(:spot))
  end
